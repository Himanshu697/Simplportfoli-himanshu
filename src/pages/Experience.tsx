  ...
  const experiences = [
    {
      ...
      duration: "2023 ",
      location: "Remote",
      description: "Led campus outreach initiatives and promoted internship opportunities to fellow students. Organized workshops and events to enhance career awareness among peers.",
      responsibilities: [
      ...
      skills: ["Leadership", "Communication", "Event Management", "Marketing"],
    ...
    },
    {
      ...
      duration: "2024",
      location: "Remote",
      description: "Developed responsive web applications and improved user experience across multiple projects. Built interactive tools and landing pages using modern web technologies.",
      responsibilities: [
        "Built temperature converter web application",
        "Developed responsive landing pages",
        "Created personal portfolio websites",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-16 text-center animate-fadeIn">
          <Card className="bg-gradient-accent p-8 border-none text-white max-w-2xl mx-auto">
            ...
            <Button 
              variant="secondary"
              className="bg-blue text-background hover:bg-white/40"
              asChild
            >
              <a href="/contact">
