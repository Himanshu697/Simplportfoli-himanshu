...
const Experience = () => {
  const experiences = [
    {
      id: 0,
      role: "Trainee-Technology Intern (.NET Full-Stack)",
      company: "Policybazaar for Business (PB Fintech Ltd)",
      type: "Internship",
      duration: "Feb 2026 - Present",
      location: "Gurgaon, India",
      description:
        "Working as a full-stack developer on enterprise-grade web applications using .NET, C#, React, and TypeScript. Building secure authentication workflows and integrating APIs for training platforms, while collaborating with cross-functional teams.",
      responsibilities: [
        "Full-stack web development using .NET, C#, React and TypeScript",
        "Developing secure authentication workflows and enterprise APIs",
        "Collaborating with cross-functional teams on performance improvements",
        "Building scalable applications for enterprise-level training platforms",
        "Enhancing maintainability and user experience across products",
      ],
      skills: [".NET", "ASP.NET Core", "C#", "React", "TypeScript", "REST APIs", "Git", "SQL"],
