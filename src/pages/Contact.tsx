  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "himanshu.goswami@example.com",
      link: "mailto:himanshu.goswami@example.com",
    ...
    },
    {
      ...
      link: "https://t.me/himanshugoswami",
  ...
  const socialLinks = [
    {
      name: "GitHub",
      icon: <Github size={24} />,
      url: "https://github.com/himanshugoswami",
    ...
    },
    {
      ...
      url: "https://linkedin.com/in/himanshugoswami",
    ...
    },
    {
      name: "LeetCode",
      icon: <Code size={24} />,
      url: "https://leetcode.com/himanshugoswami",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8 animate-slideIn delay-200">
            ...
            {/* Quick Actions */}
            <Card className="bg-gradient-accent p-6 border-none text-white">
              <h3 className="text-xl font-bold mb-4">Quick Actions</h3>
              <div className="space-y-3">
                <Button 
                  variant="secondary"
                  className="w-full bg-white text-background hover:bg-white/90 justify-start"
                  asChild
                >
                  <a href="#" download>
                ...
                <Button 
                  variant="outline"
                  className="w-full border-white text-white hover:bg-white hover:text-background justify-start"
                  asChild
                >
                  <a href="/projects">
        ...
        <div className="mt-16 text-center animate-fadeIn">
          <Card className="bg-card border border-border p-8 max-w-2xl mx-auto">
            ...
            <Button 
              ...
              asChild
            >
              <a href="mailto:himanshu.goswami@example.com">
